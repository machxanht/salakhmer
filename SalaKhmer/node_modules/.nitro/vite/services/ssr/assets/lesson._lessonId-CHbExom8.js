import { c as useLocale, l as useAuth, r as Route, u as MOCK_LESSONS } from "./router-JcPmpmb6.js";
...
import { n as stopKhmerAudio, t as playKhmerAudio } from "./audioService-CfsJ3L6R.js";
import { t as AudioSpeedSettings } from "./AudioSpeedSettings-CO0lW9Kj.js";
import { n as removeReviewItem, t as addReviewItem } from "./review-queue-xu6BhGRg.js";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { CheckCircle2, ChevronRight, Languages, Pause, Play, Repeat2, Volume2, X } from "lucide-react";
//#region src/lib/lesson-activities.ts
...
//#endregion
//#region src/lib/romanization.ts
/**
...
//#endregion
//#region src/components/ActivityRenderer.tsx
...
function ActivityRenderer({ activity, cardIndex, flipped, onFlip, onPlayAudio, onPlayPromptAudio, isPlaying, onResult }) {
	const { tr } = useLocale();
	if (activity.type === "multipleChoice" || activity.type === "audioChoice") return /* @__PURE__ */ jsx(ChoiceActivity, {
		activity,
		isPlaying,
		onPlayAudio: onPlayPromptAudio,
		onResult
	});
	if (activity.type === "timedChoice") return /* @__PURE__ */ jsx(TimedChoiceActivity, {
		activity,
		onResult
	});
	if (activity.type === "errorRepair") return /* @__PURE__ */ jsx(ErrorRepairActivity, {
		activity,
		onResult
	});
	if (activity.type === "matching") return /* @__PURE__ */ jsx(MatchingActivity, {
		pairs: activity.pairs,
		onResult
	});
	if (activity.type === "ordering") return /* @__PURE__ */ jsx(OrderingActivity, {
		items: activity.items,
		answer: activity.answer,
		onResult
	});
	if (activity.type === "writing") return /* @__PURE__ */ jsx(WritingActivity, {
		character: activity.character,
		strokes: activity.strokes,
		onResult
	});
	if (activity.type !== "flashcard") return /* @__PURE__ */ jsx("div", {
	...
	if (!card) return /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				}), activity.type === "audioChoice" && /* @__PURE__ */ jsx("button", {
					type: "button",
					disabled: isPlaying,
					"aria-label": tr("audio"),
			...
			answered && /* @__PURE__ */ jsx(Feedback, {
...
function TimedChoiceActivity({ activity, onResult }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			selected && /* @__PURE__ */ jsx(Feedback, {
				correct: selected === activity.answer,
				answer: activity.answer
			}),
			remaining === 0 && !selected ? /* @__PURE__ */ jsx("p", {
...
function ErrorRepairActivity({ activity, onResult }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			answered && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Feedback, {
				correct: selected === activity.answer,
				answer: activity.answer
			}), /* @__PURE__ */ jsx("p", {
				className: "mt-3 text-xs text-muted-foreground",
...
function MatchingActivity({ pairs, onResult }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "space-y-3",
				children: pairs.map((pair) => /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						}), pairs.map((option) => /* @__PURE__ */ jsx("option", { children: option.right }, option.right))]
					})]
				}, pair.left))
			}),
			/* @__PURE__ */ jsx("button", {
			...
			submitted && /* @__PURE__ */ jsx(Feedback, {
				correct,
...
//#endregion
//#region src/components/ConversationTranscriptLesson.tsx
			...
			children: [
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx(Languages, { className: "h-5 w-5" })
							})
						]
					}), /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("main", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("ul", {
							className: "space-y-4",
							children: lines.map((line, index) => /* @__PURE__ */ jsx(DialogueLine, {
								line,
								index,
								active: active === index,
								showEnglish,
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("button", {
									...
									children: playingAll ? /* @__PURE__ */ jsx(Pause, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx(Play, { className: "h-5 w-5 fill-current" })
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "min-w-0 flex-1",
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("span", { children: playingAll ? locale === "vi" ? "Đang phát" : "Playing" : locale === "vi" ? "Sẵn sàng" : "Ready" }), /* @__PURE__ */ jsxs("span", { children: [
											active + 1,
											"/",
											lines.length
										] })]
								...
								/* @__PURE__ */ jsx(Repeat2, { className: "h-4 w-4 text-[#786858]" })
							]
						})
					})
				})
	...
	return /* @__PURE__ */ jsxs("li", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("button", {
				...
				children: /* @__PURE__ */ jsx(Volume2, { className: active ? "h-[18px] w-[18px] animate-pulse" : "h-[18px] w-[18px]" })
			}),
...
//#endregion
//#region src/routes/lesson.$lessonId.tsx?tsr-split=component
...
function LessonPage() {
	...
	if (!lesson) return /* @__PURE__ */ jsxs("div", {
	...
	if (!(hasFullLessonTestAccess(firebaseUser?.email ?? user.email) || isCategoryAccessible(user.role, lesson.categoryId))) return /* @__PURE__ */ jsxs("div", {
	...
	if (lesson.type === "conversation" && lesson.content?.length) return /* @__PURE__ */ jsx(ConversationTranscriptLesson, {
		lesson,
	...
	if (isFinished) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(CheckCircle2, { className: `h-16 w-16 ${passed ? "text-emerald-600" : "text-amber-500"}` })
			}),
			/* @__PURE__ */ jsx("h1", {
			...
			passed && /* @__PURE__ */ jsx(PatreonSupportCard, {
				locale,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "px-4 pb-1",
				children: /* @__PURE__ */ jsx(AudioSpeedSettings, { compact: true })
			}),
			/* @__PURE__ */ jsx("div", {
				className: "flex-1 flex flex-col items-center justify-center p-6 [perspective:1000px]",
				children: /* @__PURE__ */ jsx(ActivityRenderer, {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("button", {
					...
					children: [isSaving ? t("saving") : currentIndex === activityCount - 1 ? t("complete") : t("next"), !isSaving && /* @__PURE__ */ jsx(ChevronRight, { className: "h-6 w-6" })]
				})
			})
		]
	});
