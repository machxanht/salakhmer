import { c as useLocale, l as useAuth } from "./router-JcPmpmb6.js";
import { a as LovableHeader, c as LovableSectionTitle, i as LovableBottomNav, n as LanguagePicker, s as LovableScreen, u as apsara_script_basics_teacher_default } from "./LovableAppShell-kutS1aM-.js";
import { t as hasFullLessonTestAccess } from "./tester-access-DrwpAQaY.js";
import * as React from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, BookOpen, ChevronRight, Compass, Flag, Flame, Headphones, Library, Lock, MapPin, PenLine, Sparkles, Trophy } from "lucide-react";
import { Slot } from "@radix-ui/react-slot";
import { cva } from "class-variance-authority";
import { clsx } from "clsx";
import { twMerge } from "tailwind-merge";
//#region src/lib/expedition-data.ts
...
//#endregion
//#region src/components/DailyChallenge.tsx
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(Flame, { className: "h-6 w-6" })
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("p", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("span", { children: "4 min" }),
								/* @__PURE__ */ jsx("span", {
									className: "mx-1.5 opacity-50",
									children: "•"
								}),
								/* @__PURE__ */ jsx("span", { children: "Expires 11h 22m" })
							]
						})
					]
				}),
...
//#endregion
//#region src/components/AngkorRelicsMap.tsx
var landmarkArt = {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("p", {
						...
						children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 shrink-0 text-[#D9871A]" }), " Finish lessons and answer activities correctly to earn more XP."]
					})
				]
			}),
			showDailyChallenge && /* @__PURE__ */ jsx("div", {
				className: "px-5 pb-4",
				children: /* @__PURE__ */ jsx(DailyChallenge, {})
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx(MapTrees, { className: "left-[5%] top-[13%] scale-75" }),
					/* @__PURE__ */ jsx(MapTrees, { className: "right-[4%] top-[31%] scale-90" }),
					/* @__PURE__ */ jsx(MapTrees, { className: "bottom-[7%] left-[8%] scale-[.7]" }),
					/* @__PURE__ */ jsx(MapTrees, { className: "bottom-[13%] right-[12%] scale-[.62]" }),
								...
								children: [
									...
									!unlocked && /* @__PURE__ */ jsx("span", {
										...
										children: /* @__PURE__ */ jsx("span", {
											...
											children: /* @__PURE__ */ jsx(Lock, { className: "h-3.5 w-3.5 text-[#756C5D]" })
										})
									}),
									/* @__PURE__ */ jsx("span", {
					...
					currentNode && !isGuest && /* @__PURE__ */ jsxs("div", {
					...
					isGuest && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Flag, { className: "h-4 w-4 text-[#DD6D25]" }), " Sign in to save your Angkor journey."]
					})
				]
			})
		]
...
function MapTrees({ className }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Tree, { size: "sm" }),
			/* @__PURE__ */ jsx(Tree, { size: "lg" }),
			/* @__PURE__ */ jsx(Tree, { size: "md" })
		]
	});
}
function Tree({ size }) {
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [
			/* @__PURE__ */ jsx("span", { className: "absolute bottom-0 left-1/2 h-[48%] w-1 -translate-x-1/2 rounded-full bg-[#6C5837]" }),
			/* @__PURE__ */ jsx("span", { className: "absolute left-0 top-0 h-[68%] w-full rounded-[48%] bg-[#4C8C5B] shadow-[inset_0_-5px_0_rgba(36,104,64,.18)]" }),
			/* @__PURE__ */ jsx("span", { className: "absolute left-[18%] top-[12%] h-[42%] w-[64%] rounded-[48%] border-l border-[#D7F0B9]/70" })
		]
	});
}
//#endregion
...
function HomePage() {
	...
	return /* @__PURE__ */ jsxs(LovableScreen, { children: [
		/* @__PURE__ */ jsx(LovableHeader, {
			eyebrow: "SalaKhmer",
			title: tr("homeGreeting", { name: firstName }),
			right: /* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ jsx(LanguagePicker, {}), /* @__PURE__ */ jsx(Link, {
					to: "/profile",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Start lesson ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							})
						]
					}),
					/* @__PURE__ */ jsx("img", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			}), /* @__PURE__ */ jsx(AngkorRelicsMap, { showDailyChallenge: false })]
		}),
