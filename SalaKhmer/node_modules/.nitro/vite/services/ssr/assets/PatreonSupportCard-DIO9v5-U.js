...
//#region src/components/PatreonSupportCard.tsx
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(Heart, { className: "h-3.5 w-3.5 fill-current" })
					}), /* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsxs("a", {
					...
					children: [
						/* @__PURE__ */ jsx(Heart, { className: "h-3.5 w-3.5 fill-[#FF7272] text-[#FF7272]" }),
						copy.action,
						/* @__PURE__ */ jsx(ExternalLink, { className: "h-3.5 w-3.5 opacity-70" })
					]
				})
			]
		})]
