import { l as useAuth } from "./router-JcPmpmb6.js";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/AudioSpeedSettings.tsx
var PLAYBACK_RATES = [
	.6,
	1,
	1.25
...
function AudioSpeedSettings({ compact = false }) {
	...
	if (compact) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", {
			...
			children: "Speed"
		}), PLAYBACK_RATES.map((rate) => /* @__PURE__ */ jsxs("button", {
			type: "button",
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				role: "group",
				"aria-label": "Audio speed",
				children: PLAYBACK_RATES.map((rate) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					"aria-pressed": selectedRate === rate,
					onClick: () => void updateUser({ audioSettings: {
						...user.audioSettings,
