import { c as useLocale, l as useAuth, s as LOCALES } from "./router-JcPmpmb6.js";
import { a as LovableHeader, i as LovableBottomNav, s as LovableScreen } from "./LovableAppShell-kutS1aM-.js";
...
//#region src/lib/dictionary-api.ts
...
//#endregion
//#region src/routes/dictionary.tsx?tsr-split=component
var copy = {
	en: {
...
function DictionaryPage() {
	...
	return /* @__PURE__ */ jsxs(LovableScreen, { children: [
			...
			children: [
				...
				/* @__PURE__ */ jsxs("form", {
					...
					children: [/* @__PURE__ */ jsxs("label", {
						...
						children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-3.5 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-[#A99B8C]" }), /* @__PURE__ */ jsx("input", {
							value: query,
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(Languages, { className: "h-4 w-4 shrink-0 text-[#287E75]" }),
						/* @__PURE__ */ jsx("span", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: LOCALES.filter((item) => item.id !== targetLocale).map((item) => /* @__PURE__ */ jsxs("div", {
						...
						result.glossary && result.explanation?.[targetLocale] && /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								result.relatedLevel && /* @__PURE__ */ jsxs("p", {
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsx(PatreonSupportCard, { locale })
		}),
