import { c as useLocale, f as loginWithEmail, g as resetPassword, h as registerWithEmail, l as useAuth, m as loginWithGoogle, o as Route, p as loginWithFacebook } from "./router-JcPmpmb6.js";
import { t as logo_default } from "./logo-5e2hnhS0.js";
import { useEffect, useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertCircle, Eye, EyeOff, Loader2, Lock, Mail, User } from "lucide-react";
//#region src/assets/logo-1.svg
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				mode !== "reset" && /* @__PURE__ */ jsx("div", {
					className: "mb-6 flex rounded-2xl bg-secondary p-1",
					children: ["login", "register"].map((m) => /* @__PURE__ */ jsx("button", {
						onClick: () => {
							setMode(m);
							clearState();
						},
				...
				/* @__PURE__ */ jsxs("form", {
					...
					children: [
						...
						mode === "register" && /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [/* @__PURE__ */ jsx(User, { className: "absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
								id: "input-name",
								type: "text",
								placeholder: t("name"),
								value: name,
						...
						/* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [/* @__PURE__ */ jsx(Mail, { className: "absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
								id: "input-email",
								type: "email",
								placeholder: t("email"),
								value: email,
						...
						mode !== "reset" && /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [
								/* @__PURE__ */ jsx(Lock, { className: "absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }),
								/* @__PURE__ */ jsx("input", {
									id: "input-password",
						...
						error && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(AlertCircle, { className: "h-4 w-4 shrink-0" }), error]
						}),
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						mode === "reset" && /* @__PURE__ */ jsx("button", {
							onClick: () => {
								setMode("login");
								clearState();
							},
