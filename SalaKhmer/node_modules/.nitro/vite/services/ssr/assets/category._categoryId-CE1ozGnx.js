import { a as Route, c as useLocale, l as useAuth, u as MOCK_LESSONS } from "./router-JcPmpmb6.js";
import { a as LEVEL_5_INDEPENDENT_VOWELS, i as LEVEL_4_DEPENDENT_VOWELS, o as LEVEL_6_NUMERALS } from "./khmerAlphabetData-CJ1SnSWu.js";
import { c as LovableSectionTitle, i as LovableBottomNav, l as getLocalizedModuleCopy, r as LongPageNav, s as LovableScreen, t as LOVABLE_MODULES } from "./LovableAppShell-kutS1aM-.js";
import { t as PatreonSupportCard } from "./PatreonSupportCard-DIO9v5-U.js";
import { t as hasFullLessonTestAccess } from "./tester-access-DrwpAQaY.js";
import { o as TopicCover, r as READ_SPELL_TOPICS, t as getLocalizedReadSpellTopic } from "./read-spell-localization-DngSCBWw.js";
import { n as localizeLegacyText, r as isCategoryAccessible, t as localizeLegacyLesson } from "./content-localization-CdbR65H0.js";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Banknote, BookOpen, Check, ChevronLeft, ChevronRight, Compass, Download, Eye, EyeOff, Headphones, Lock, PenLine, PenTool, RotateCcw, Type, Users } from "lucide-react";
//#region src/components/AlphabetGrid.tsx
var LEVELS = [
	{
		id: "alpha-l1",
				...
				return /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							isNextToLearn && /* @__PURE__ */ jsx(Link, {
							...
							!isUnlocked && !isCompleted && /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/KingdomInsights.tsx
...
var INSIGHTS = [
		...
		content: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("p", { children: [
					...
					/* @__PURE__ */ jsx("strong", { children: "Sampeah" }),
				...
				/* @__PURE__ */ jsxs("ul", {
					...
					children: [
						/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Level 1 (chest):" }), " Greet friends and peers."] }),
						/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Level 2 (mouth):" }), " Greet older people or a superior."] }),
						/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Level 3 (nose):" }), " Greet parents, grandparents, or teachers."] }),
						/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Level 4 (eyebrows):" }), " Greet a king or monk."] }),
						/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Level 5 (forehead):" }), " Pray to deities."] })
					]
				}),
				/* @__PURE__ */ jsx("p", {
		...
		content: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("p", { children: [
					...
					/* @__PURE__ */ jsx("strong", { children: "Riel (KHR)" }),
					" and the",
					" ",
					/* @__PURE__ */ jsx("strong", { children: "US dollar (USD)" }),
					"."
				] }),
				/* @__PURE__ */ jsxs("ul", {
					className: "list-disc pl-5 space-y-2 text-sm",
					children: [/* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Small change (under $1):" }), " You will usually receive change in Riel. 4000 Riel = $1."] }), /* @__PURE__ */ jsxs("li", { children: [/* @__PURE__ */ jsx("strong", { children: "Whole dollars ($1 or more):" }), " You can use US dollars almost everywhere, from supermarkets to tuk-tuks."] })]
				}),
				/* @__PURE__ */ jsxs("div", {
	...
	},
	{
		...
		content: /* @__PURE__ */ jsx("p", { children: "Agree the fare before the ride, keep small notes for change, and save your hotel name in Khmer for the return trip." })
	},
	{
		id: "temples",
		...
		content: /* @__PURE__ */ jsx("p", { children: "Cover shoulders and knees at temples, remove hats where requested, and speak quietly near monks and worshippers." })
	},
	{
		id: "food",
		...
		content: /* @__PURE__ */ jsxs("p", { children: [
			...
			/* @__PURE__ */ jsx("strong", { children: "កុំហឹរ" }),
			" (kom her)."
		] })
	},
	{
		...
		content: /* @__PURE__ */ jsx("p", { children: "Choose sealed bottled water. In established cafés, factory ice is usually safe; use your own judgement in remote areas." })
	},
	{
		id: "markets",
		...
		content: /* @__PURE__ */ jsx("p", { children: "Ask the price first, bargain gently when appropriate, and walk away warmly if a price does not work for you." })
	},
	{
		id: "monks",
		title: "Meeting monks",
		...
		content: /* @__PURE__ */ jsx("p", { children: "Offer objects with both hands when possible. Women should avoid touching monks and can place an item on a table instead." })
	},
	{
		id: "phones",
		...
		content: /* @__PURE__ */ jsx("p", { children: "A local eSIM or SIM is inexpensive. Download an offline map and keep your accommodation address saved before travelling." })
	},
	{
		id: "weather",
		...
		content: /* @__PURE__ */ jsx("p", { children: "Carry sun protection year-round. During the wet season, brief heavy showers are normal, so a light rain layer helps." })
	},
	{
		id: "polite",
		...
		content: /* @__PURE__ */ jsx("p", { children: "Avoid pointing feet at people or sacred objects. Pass items with your right hand or both hands when you can." })
	},
	{
		id: "emergency",
		...
		content: /* @__PURE__ */ jsxs("p", { children: [
			"Save ",
			/* @__PURE__ */ jsx("strong", { children: "ជួយខ្ញុំផង" }),
	...
	},
	{
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Place the pickup pin where the driver can stop safely, then compare the Khmer place name with the map before leaving." }), /* @__PURE__ */ jsx("p", { children: "Save a screenshot of your accommodation name, phone number, and Khmer address in case mobile data is unavailable." })]
		})
	},
	{
		id: "road-crossing",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Use a marked crossing or traffic light where one is available. Look in both directions, because vehicles may approach from an unexpected side." }), /* @__PURE__ */ jsx("p", { children: "Avoid stepping out from behind parked vehicles, especially after dark or during rain." })]
		})
	},
	{
		id: "checking-change",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Confirm the total before paying and count your change while you are still at the counter." }), /* @__PURE__ */ jsx("p", { children: "Keep small riel notes separate from larger notes so everyday purchases are quicker and clearer." })]
		})
	},
	{
		id: "heat",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Carry sealed water, use shade, and schedule demanding walks for cooler parts of the day." }), /* @__PURE__ */ jsx("p", { children: "If you feel dizzy or unusually weak, stop, cool down, and ask for help rather than trying to push on." })]
		})
	},
	{
		id: "laundry",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Ask whether the price is per item or by weight, and confirm when the clothes will be ready." }), /* @__PURE__ */ jsx("p", { children: "Point out delicate items, stains, or anything that must not go in a dryer before handing over the bag." })]
		})
	},
	{
		id: "home-shoes",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "If shoes are lined up outside a home, room, or sacred area, remove yours before entering." }), /* @__PURE__ */ jsx("p", { children: "Place them neatly without blocking a doorway, and avoid stepping over someone else's belongings." })]
		})
	},
	{
		id: "photography",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Ask permission before photographing an identifiable person at close range, especially children, monks, workers, or worshippers." }), /* @__PURE__ */ jsx("p", { children: "Respect any no-photo sign and never interrupt a ceremony just to get a better angle." })]
		})
	},
	{
		id: "rural-visits",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Stay on established paths, ask before entering private land, and carry your rubbish back out." }), /* @__PURE__ */ jsx("p", { children: "Buy locally when appropriate, but do not distribute gifts or photograph residents without guidance and consent." })]
		})
	},
	{
		id: "pharmacy",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Show the generic medicine name, dosage, allergy information, and a photo of the original packaging when possible." }), /* @__PURE__ */ jsx("p", { children: "For severe symptoms, breathing difficulty, major injury, or uncertainty, seek qualified medical care instead of relying only on self-treatment." })]
		})
	},
	{
		id: "charging",
		...
		content: /* @__PURE__ */ jsxs("div", {
			className: "space-y-3",
			children: [/* @__PURE__ */ jsx("p", { children: "Carry a suitable adapter and a small power bank, and charge before long travel days." }), /* @__PURE__ */ jsx("p", { children: "Use your own cable when possible and keep an offline copy of essential addresses, tickets, and contact numbers." })]
		})
	}
];
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h3", {
					...
					children: [/* @__PURE__ */ jsx(Compass, { className: "h-5 w-5" }), " Cambodia Handbook"]
				}), /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: INSIGHTS.map((insight) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 mb-2" }), /* @__PURE__ */ jsx("div", {
					...
					return /* @__PURE__ */ jsxs("article", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: typeof copy.content === "string" ? /* @__PURE__ */ jsx("p", { children: copy.content }) : copy.content
							}),
							/* @__PURE__ */ jsx(PatreonSupportCard, {
								locale,
								className: "mx-5 mb-5"
							}),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsx(BookOpen, { className: "h-3.5 w-3.5" }), " Survival knowledge"]
								}), /* @__PURE__ */ jsx("button", {
...
//#endregion
//#region src/components/VideoTracedHandwritingPreview.tsx
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(PracticeGrid$1, {}), /* @__PURE__ */ jsx("img", {
			...
			/* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(RotateCcw, { className: "h-4 w-4" }), " Replay writing animation"]
			}),
			/* @__PURE__ */ jsxs("p", {
...
function PracticeGrid$1() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-[12%] h-px bg-[#b9a36c]" }),
		/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-[31%] h-px bg-[#d8c89e]" }),
		/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-1/2 h-px bg-[#b9a36c]" }),
		/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-[69%] h-px bg-[#d8c89e]" }),
		/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-[88%] h-px bg-[#b9a36c]" }),
		/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-y-0 left-1/2 w-px border-l border-dashed border-[#d8c89e]" })
	] });
}
//#endregion
//#region src/components/StrokeOrderDrawing.tsx
var LETTERS = [
	{
		char: "ក",
		name: "Kâ",
...
function StrokeOrderDrawing() {
	const { locale } = useLocale();
	const [activeGroup, setActiveGroup] = useState("o-consonants");
	const [letterIndex, setLetterIndex] = useState(0);
	const [practiceTab, setPracticeTab] = useState("model");
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h3", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(PenTool, { className: "h-5 w-5" })
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: WRITING_GROUPS.map((group) => /* @__PURE__ */ jsx("button", {
					type: "button",
					onClick: () => {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: activeItems.map((item, index) => /* @__PURE__ */ jsx("button", {
					type: "button",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					practiceTab === "model" ? hasVideoTracedDraft(letter.char) ? /* @__PURE__ */ jsx(VideoTracedHandwritingPreview, { character: letter.char }) : /* @__PURE__ */ jsxs("div", {
						className: "relative mx-auto grid aspect-square w-full max-w-sm place-items-center overflow-hidden rounded-2xl border-2 border-gold/30 bg-[#fffdf5]",
						children: [/* @__PURE__ */ jsx(PracticeGrid, {}), /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(PracticeGrid, {}),
							showModel && /* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(RotateCcw, { className: "h-4 w-4" }), " Clear"]
							}),
							/* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [showModel ? /* @__PURE__ */ jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" }), showModel ? "Hide model" : "Show model"]
							}),
							/* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [saved ? /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }), saved ? "Saved" : "Save practice"]
							})
						]
					}),
					/* @__PURE__ */ jsx(PatreonSupportCard, {
...
//#endregion
//#region src/routes/category.$categoryId.tsx?tsr-split=component
var scriptLessons = [
	"alpha-l1",
	"alpha-l2",
	"alpha-l3",
...
function CategoryPage() {
	...
	if (!module) return /* @__PURE__ */ jsx(LovableScreen, { children: /* @__PURE__ */ jsx("div", {
		className: "p-6",
	...
	return /* @__PURE__ */ jsxs(LovableScreen, { children: [
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [module.art && /* @__PURE__ */ jsx("img", {
				src: module.art,
				alt: "",
				"aria-hidden": "true",
		...
		/* @__PURE__ */ jsxs("section", {
			className: "px-5 pt-8",
			children: [!access && /* @__PURE__ */ jsxs("div", {
				className: "rounded-[18px] border border-[#E5D5BC] bg-[#FFF8E8] p-5 text-center",
				children: [
					/* @__PURE__ */ jsx(Lock, { className: "mx-auto h-6 w-6 text-[#A9631E]" }),
					/* @__PURE__ */ jsx("h2", {
			...
			}), access && /* @__PURE__ */ jsxs(Fragment, { children: [
				catId !== "module_1" && /* @__PURE__ */ jsx(LovableSectionTitle, {
					title: t("lessons"),
					note: t("audioIncluded")
				}),
				catId === "module_1" && /* @__PURE__ */ jsx("div", {
					className: "mb-6",
					children: /* @__PURE__ */ jsx(AlphabetGrid, {})
				}),
				catId === "module_2" && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", {
					className: "mb-6 grid grid-cols-2 gap-3",
					children: READ_SPELL_TOPICS.map((topic) => /* @__PURE__ */ jsxs(Link, {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(TopicCover, {
				...
				catId === "module_4" && /* @__PURE__ */ jsx("div", {
					className: "mb-6",
					children: /* @__PURE__ */ jsx(StrokeOrderDrawing, {})
				}),
				catId === "module_6" && /* @__PURE__ */ jsx("div", {
					className: "mb-6",
					children: /* @__PURE__ */ jsx(KingdomInsights, {})
				}),
				catId !== "module_1" && catId !== "module_4" && publishedContent.length > 0 && /* @__PURE__ */ jsxs("div", {
					className: "mb-6 space-y-3",
					children: [/* @__PURE__ */ jsx(LovableSectionTitle, {
						title: locale === "vi" ? "Nội dung đã xuất bản" : "Published updates",
						note: `${publishedContent.length}`
					}), publishedContent.map((item) => /* @__PURE__ */ jsxs("article", {
				...
				catId !== "module_1" && catId !== "module_2" && catId !== "module_4" && /* @__PURE__ */ jsx("div", {
					className: "flex flex-col gap-3",
					children: lessons.map((lesson, index) => /* @__PURE__ */ jsx(LessonRow, {
						index: index + 1,
						lesson,
		...
		/* @__PURE__ */ jsx(LongPageNav, {}),
		/* @__PURE__ */ jsx(LovableBottomNav, {})
	] });
}
function LessonRow({ index, lesson, complete, moduleId }) {
	const isScript = lesson.id.startsWith("alpha-");
	const icon = moduleId === "module_3" ? /* @__PURE__ */ jsx(Headphones, { className: "h-5 w-5" }) : moduleId === "module_4" ? /* @__PURE__ */ jsx(PenLine, { className: "h-5 w-5" }) : moduleId === "module_1" ? /* @__PURE__ */ jsx(Type, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx(BookOpen, { className: "h-5 w-5" });
	...
	return /* @__PURE__ */ jsxs(Link, {
		...
		children: [
			/* @__PURE__ */ jsx("span", {
				...
				children: complete ? /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }) : index
			}),
			/* @__PURE__ */ jsxs("span", {
			...
			/* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-[#A99B8C]" })
		]
	});
}
//#endregion
