//#region node_modules/.nitro/vite/services/ssr/assets/khmerAlphabetData-CJ1SnSWu.js
var FIRST_SERIES_HINT = "Rhyme the ending with ‘aw’ in ‘law’.";
var SECOND_SERIES_HINT = "Rhyme the ending with ‘o’ in ‘go’.";
var ASPIRATED = " Release it with a clear puff of air.";
var CONSONANT_PHONETICS = {
	"c-ka": {
		romanization: "k",
		learnerReading: "K-aw",
...
function enrichConsonant(character) {
	const guide = CONSONANT_PHONETICS[character.id];
	return {
		...character,
		...guide,
		phonetic: guide.learnerReading,
		englishRhyme: character.series === "A" ? "ending sounds like ‘aw’ in ‘law’" : "ending sounds like ‘o’ in ‘go’"
	};
}
var LEVEL_1_CONSONANTS_A = [
	{
		id: "c-ka",
		khmer: "ក",
		latin: "Ka",
...
[...LEVEL_1_CONSONANTS_A, ...LEVEL_2_CONSONANTS_O];
var LEVEL_3_SUB_CONSONANTS = [
	{
		id: "sub-ka",
		khmer: "្ក",
		latin: "Coeng Ka"
...
var LEVEL_5_INDEPENDENT_VOWELS = [
	{
		id: "iv-01",
		khmer: "ឥ",
		latin: "I / Ih",
		phonetic: "I / Ih",
		englishHint: "Like 'i' in 'it'",
		ttsText: "ឥ"
	},
	{
		id: "iv-02",
	...
	},
	{
		...
		latin: "Ov / Au",
		phonetic: "Ov / Au",
		englishHint: "Like 'oh' blending into 'v', or 'ow'",
		ttsText: "ឪ"
	},
	{
		id: "iv-07",
		...
		latin: "Rue",
		phonetic: "Rue",
		englishHint: "Like 'rue' with a rolled R",
		ttsText: "ឫ"
	},
	{
		id: "iv-08",
		...
		latin: "Ruee",
		phonetic: "Ruee",
		englishHint: "Long 'rue', heavily rolled R",
		ttsText: "ឬ"
	},
	{
		id: "iv-09",
	...
	},
	{
		...
		latin: "Au",
		phonetic: "Au",
		englishHint: "Like 'ow' in 'cow'",
		ttsText: "ឳ"
	}
];
var LEVEL_6_NUMERALS = [
	{
		id: "num-0",
		khmer: "០",
		latin: "Soun (0)"
	...
	},
	{
		id: "num-10000",
		khmer: "១០០០០",
		latin: "Moi Meun (10000)"
	},
	{
		id: "num-1000000",
		khmer: "១០០០០០០",
		latin: "Moi Lean (1000000)"
	},
	{
		id: "num-1000000000",
		khmer: "១០០០០០០០០០",
		latin: "Moi Koat (1000000000)"
	}
];
//#endregion
export { LEVEL_5_INDEPENDENT_VOWELS as a, LEVEL_4_DEPENDENT_VOWELS as i, LEVEL_2_CONSONANTS_O as n, LEVEL_6_NUMERALS as o, LEVEL_3_SUB_CONSONANTS as r, LEVEL_1_CONSONANTS_A as t };
